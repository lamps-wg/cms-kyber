...
ML-KEM is an IND-CCA2-secure key-encapsulation mechanism (KEM) standardized in {{FIPS203}} by the US NIST PQC Project {{NIST-PQ}}. ML-KEM is a standardized and incompatible version of the older Kyber algorithm.
